...
M.highlights_base = function (colors)
  return {
    ...
    Pmenu = { fg = colors.foreground, bg = none },
    PmenuSel = { fg = none, bg = colors.color4 },
    ...
    DiffAdd = { fg = none, bg = colors.color4 },
    DiffChange = { fg = none, bg = colors.color5 },
    DiffDelete = { fg = none, bg = colors.color11 },
    ...
    Constant = { fg = colors.color13 },
    Number = { fg = colors.color9 },
    Boolean = { fg = colors.color10 },
    Float = { fg = colors.color9 },
    Identifier = { fg = colors.color13 },
    Function = { fg = colors.color6 },
    Operator = { fg = colors.color6 },
    Type = { fg = colors.color13 },
    ...
    TSNote = { fg = none, bg = colors.color5 },
    TSComment = { fg = colors.color1 },
    TSWarning = { fg = none, bg = colors.color5 },
    TSDanger = { fg = none, bg = colors.color3 },
   ...
   -- Neogit
    ...
    TelescopeSelection = { fg = none, bg = colors.color1 },
    ...
    NvimTreeStatusLineNC = { bg = none, fg = none },
